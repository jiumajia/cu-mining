...
import features_pre.dummy_features
import mining.read_data
...
def fill_data(dataset,col_name,method):
    """
    按列填充空缺值
    col_name
...
def set_features(self):
    ...
    self.dataset = features_pre.dummy_features(self.dataset, dic)
